...
const MembersScreen = ({ members, onChat }: { members: ParentProfileData[], onChat: (m: BaseProfile) => void }) => {
...
const App = () => {
    ...
    const [members, setMembers] = useState<ParentProfileData[]>(initialMembers);
    ...
    const handleRegister = (user: UserProfile) => {
        ...
        if (user.role === 'teacher') {
            ...
            setMembers(prev => [user as ParentProfileData, ...prev]);
        }
    };
    ...
    const renderTab = () => {
        ...
        switch (activeTab) {
            ...
            case 'members': return <MembersScreen members={members} onChat={setActiveChat} />;
